...
//"https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1&mbl=0&mkt="
let BingImageURL = "https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1&mbl=0&mkt=";
const BingImageURLPre= "https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1&mbl=1&mkt=";
const BingBaseImageURL= "https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1&mkt=en-ww";
...
const BingWallpaperIndicator = new Lang.Class({
    ...
    _showDescription: function() {
        if (this.title == "" && this.explanation == "") {
            ...
            if (this.copyright != "")
                //message += "\n\<a\"+ "url=\""+BingImageURL+"\"+"\>\"+ this.copyright+"\<\/a\>"
                message += "\n"+""+ this.copyright+ "\n"+BingImageURL+"";
