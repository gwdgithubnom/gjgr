...
import org.gjgr.github.commit.GHCommitComment;
import org.gjgr.github.commit.GHCommitState;
import org.gjgr.github.commit.GHCommitStatus;
import org.gjgr.github.content.GHContent;
import org.gjgr.github.deploy.GHDeployKey;
import org.gjgr.github.deploy.GHDeployment;
import org.gjgr.github.deploy.GHDeploymentState;
import org.gjgr.github.deploy.GHDeploymentStatus;
import org.gjgr.github.event.GHEvent;
import org.gjgr.github.event.GHEventInfo;
import org.gjgr.github.event.GHEventPayload;
import org.gjgr.github.issue.GHIssue;
import org.gjgr.github.issue.GHIssueComment;
import org.gjgr.github.issue.GHIssueState;
import org.gjgr.github.manager.GHBranch;
import org.hamcrest.CoreMatchers;
import org.junit.Assume;
import org.junit.Test;
import org.gjgr.github.commit.GHCommit.File;
...
//        System.out.println(hub.getUser("kohsuke").getRepository("hudson").getCollaborators());
    ...
    private void tryTeamCreation(GitHub gitHub) throws IOException {
        ...
        GHTeam t = o.createTeam("auto team", GHOrganization.Permission.PUSH);
