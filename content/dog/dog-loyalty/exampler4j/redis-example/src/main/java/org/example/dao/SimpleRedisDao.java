...
import org.example.tools.Client;
...
public class SimpleRedisDao {
    ...
    private static final Logger log = Logger.getLogger(SimpleRedisDao.class);
    private Client client;
    public void disconnect() {
        ShardedJedis shardedJedis = client.getRedisClient();
    ...
    public String set(String key, String value) {
        ...
        try {
            ...
            client.returnResource(shardedJedis, flag);
        }
        return result;
    }
